...
<head>
  <meta charset="UTF-8">
  <title>contact</title>
  <link rel="stylesheet" href="{{ 'storage/css/contact.css' }}">
...
<div class="container">
  <div class="row">
    <div class="col">
      <p class="text-center tenor-sans-regular">CONTACT</p>
    </div>
  </div>
  <div class="row">
    <div class="col">
  ...
  <form class="contactForm">
    ...
    <div class="row mb-2">
      <div class="col">
        <textarea class="form-control message" placeholder="Message" rows="5"></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col">
